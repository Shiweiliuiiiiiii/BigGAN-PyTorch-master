...
#SBATCH -J Biggan_Drandom_0.5D          # 所运行的任务名称 (自己取)
...
#SBATCH -o Biggan_Drandom_0.5D.out        # 打印输出的文件
...
do
  ...
  --sparse --sema --dy_mode GD --imbalanced --density 0.5 --densityG $densityG --G_growth gradient --D_growth random --update_frequency 500 \
