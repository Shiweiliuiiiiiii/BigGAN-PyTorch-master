...
#SBATCH -J fix_ratio6789            # 所运行的任务名称 (自己取)
...
#SBATCH -o Biggan_c10_03_0.6_0.7_0.8_0.9_fix       # 打印输出的文件
source /public/data2/software/software/anaconda3/bin/activate
conda activate GAN1
python train.py \
--shuffle --batch_size 50 --parallel --sparse --density 0.3 --ratio_G 0.6 \
...
python train.py \
--shuffle --batch_size 50 --parallel --sparse --density 0.3 --ratio_G 0.7 \
--num_G_accumulations 1 --num_D_accumulations 1 --num_epochs 500 \
--num_D_steps 4 --G_lr 2e-4 --D_lr 2e-4 \
--dataset C10 \
--G_ortho 0.0 \
...
python train.py \
--shuffle --batch_size 50 --parallel --sparse --density 0.3 --ratio_G 0.8 \
--num_G_accumulations 1 --num_D_accumulations 1 --num_epochs 500 \
--num_D_steps 4 --G_lr 2e-4 --D_lr 2e-4 \
--dataset C10 \
--G_ortho 0.0 \
...
python train.py \
--shuffle --batch_size 50 --parallel --sparse --density 0.3 --ratio_G 0.9 \
--num_G_accumulations 1 --num_D_accumulations 1 --num_epochs 500 \
--num_D_steps 4 --G_lr 2e-4 --D_lr 2e-4 \
--dataset C10 \
--G_ortho 0.0 \
