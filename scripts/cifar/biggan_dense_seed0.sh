...
#SBATCH -J Biggan_dense_seed0            # 所运行的任务名称 (自己取)
...
#SBATCH -o Biggan_dense_seed0.out     # 打印输出的文件
...
do
  ...
  do
    ...
    --imbalanced --densityD $densityD --densityG $densityG --G_growth gradient --D_growth random --update_frequency 10 \
