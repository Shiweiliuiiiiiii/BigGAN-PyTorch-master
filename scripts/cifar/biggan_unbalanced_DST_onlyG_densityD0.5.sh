...
#SBATCH -J Biggan_unbalanced_DST_onlyG_D0.5            # 所运行的任务名称 (自己取)
...
#SBATCH -o Biggan_unbalanced_DST_onlyG_D0.5.out     # 打印输出的文件
...
do
  ...
  --sparse --sema --imbalanced --densityD $densityD --dy_mode G --densityG $densityG --G_growth gradient --D_growth random --update_frequency 500 \
