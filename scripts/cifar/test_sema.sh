...
#SBATCH -J Biggan_test_sema            # 所运行的任务名称 (自己取)
...
#SBATCH -o Biggan_test_sema.out     # 打印输出的文件
source /public/data2/software/software/anaconda3/bin/activate
conda activate GAN1

python train.py \
--shuffle --batch_size 50 --parallel \
--sparse --dy_mode GD --sema --density 0.3 --densityG 0.05 --G_growth gradient --D_growth random --update_frequency 500 \
...
--test_every 1000 --save_every 2000 --num_best_copies 5 --num_save_copies 2 --seed 1
