...
#SBATCH -J Biggan_FT_frequency_gradient_sema_seed1           # 所运行的任务名称 (自己取)
...
#SBATCH -o Biggan_FT_frequency_gradient_sema_seed1    # 打印输出的文件
...
do
  ...
  --sparse --sema --imbalanced --density 0.3 --dy_mode GD --densityG 0.05 --G_growth gradient --D_growth gradient --update_frequency $fre \
