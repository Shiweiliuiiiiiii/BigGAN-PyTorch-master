...
#SBATCH -J Biggan_unbalanced_static_densityD0.5            # 所运行的任务名称 (自己取)
...
#SBATCH -o Biggan_unbalanced_static_densityD0.5.out     # 打印输出的文件
...
do
  ...
  do
    ...
    --sparse --sema --imbalanced --densityD $densityD --densityG $densityG --G_growth gradient --D_growth random --update_frequency 10 \
    ...
    --test_every 5000 --save_every 2000 --num_best_copies 1 --num_save_copies 1 --seed $seed
  done
done