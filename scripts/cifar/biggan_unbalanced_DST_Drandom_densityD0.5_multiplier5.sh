...
#SBATCH -J Biggan_unbalanced_DST_Drandom_D0.5_x5            # 所运行的任务名称 (自己取)
...
#SBATCH -o Biggan_unbalanced_DST_Drandom_D0.5_x5.out     # 打印输出的文件
...
do
  ...
  --num_G_accumulations 1 --num_D_accumulations 1 --num_epochs 500 --multiplier 5 \
