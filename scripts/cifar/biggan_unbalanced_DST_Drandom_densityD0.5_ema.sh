...
#SBATCH -J Biggan_unbalanced_DST_Drandom_D0.5_ema            # 所运行的任务名称 (自己取)
...
#SBATCH -o Biggan_unbalanced_DST_Drandom_D0.5_ema.out     # 打印输出的文件
...
do
  ...
  --sparse --imbalanced --densityD $densityD --dy_mode GD --densityG $densityG --G_growth gradient --D_growth random --update_frequency 500 \
